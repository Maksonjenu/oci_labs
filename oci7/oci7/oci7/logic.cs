...
namespace oci_1
{
    class logic
    {
        ...
        public MKeyPoint[] pointDetector(Image<Bgr, byte> image, int mode)
        {
            switch (mode)
            {
                case 0:
        ...
        public Image<Bgr, byte> pointDraw(Image<Bgr, byte> image, MKeyPoint[] points)
        {
        ...
        {
            var mkpoints = pointDetector(image, mode);
        ...
        public Image<Bgr, byte> PointHomograph(Image<Bgr, byte> image, Image<Bgr, byte> image2)
        {
            Image<Gray, byte> baseImgGray = image.Convert<Gray, byte>();
            Image<Gray, byte> twistedImgGray = image2.Convert<Gray, byte>();
            Brisk descriptor = new Brisk();
